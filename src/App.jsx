...
function getTP(vdot) {
  ...
  return { easy:`${fmt(spk(0.65))}縲・{fmt(spk(0.74))}`, marathon:fmt(spk(0.82)), threshold:fmt(spk(0.85)), interval:fmt(spk(0.975)), rep:fmt(spk(1.1)) };
}
const CATS = [
  {id:"m_elem4",l:"蟆・逕ｷ蟄・,s:"蟆・逕ｷ",c:"#7dd3fc",g:"蟆丞ｭｦ逕滂ｼ育塙蟄撰ｼ・},{id:"m_elem5",l:"蟆・逕ｷ蟄・,s:"蟆・逕ｷ",c:"#7dd3fc",g:"蟆丞ｭｦ逕滂ｼ育塙蟄撰ｼ・},{id:"m_elem6",l:"蟆・逕ｷ蟄・,s:"蟆・逕ｷ",c:"#7dd3fc",g:"蟆丞ｭｦ逕滂ｼ育塙蟄撰ｼ・},
  {id:"m_jhs1",l:"荳ｭ1逕ｷ蟄・,s:"荳ｭ1逕ｷ",c:"#7dd3fc",g:"荳ｭ蟄ｦ逕滂ｼ育塙蟄撰ｼ・},{id:"m_jhs2",l:"荳ｭ2逕ｷ蟄・,s:"荳ｭ2逕ｷ",c:"#7dd3fc",g:"荳ｭ蟄ｦ逕滂ｼ育塙蟄撰ｼ・},{id:"m_jhs3",l:"荳ｭ3逕ｷ蟄・,s:"荳ｭ3逕ｷ",c:"#7dd3fc",g:"荳ｭ蟄ｦ逕滂ｼ育塙蟄撰ｼ・},
  {id:"m_hs",l:"鬮俶｡逕ｷ蟄・,s:"鬮俶｡逕ｷ",c:"#2563eb",g:"鬮俶｡逕滂ｼ育塙蟄撰ｼ・},{id:"m_univ",l:"螟ｧ蟄ｦ逕ｷ蟄・,s:"螟ｧ蟄ｦ逕ｷ",c:"#2563eb",g:"螟ｧ蟄ｦ逕滂ｼ育塙蟄撰ｼ・},
  {id:"m_20s",l:"20莉｣逕ｷ蟄・,s:"20莉｣逕ｷ",c:"#2563eb",g:"繝槭せ繧ｿ繝ｼ繧ｺ・育塙蟄撰ｼ・},{id:"m_30s",l:"30莉｣逕ｷ蟄・,s:"30莉｣逕ｷ",c:"#2563eb",g:"繝槭せ繧ｿ繝ｼ繧ｺ・育塙蟄撰ｼ・},{id:"m_40s",l:"40莉｣逕ｷ蟄・,s:"40莉｣逕ｷ",c:"#2563eb",g:"繝槭せ繧ｿ繝ｼ繧ｺ・育塙蟄撰ｼ・},{id:"m_50s",l:"50莉｣逕ｷ蟄・,s:"50莉｣逕ｷ",c:"#2563eb",g:"繝槭せ繧ｿ繝ｼ繧ｺ・育塙蟄撰ｼ・},{id:"m_60s",l:"60莉｣逕ｷ蟄・,s:"60莉｣逕ｷ",c:"#2563eb",g:"繝槭せ繧ｿ繝ｼ繧ｺ・育塙蟄撰ｼ・},{id:"m_70s",l:"70莉｣莉･荳顔塙蟄・,s:"70莉｣莉･荳顔塙",c:"#2563eb",g:"繝槭せ繧ｿ繝ｼ繧ｺ・育塙蟄撰ｼ・},
  {id:"f_elem4",l:"蟆・螂ｳ蟄・,s:"蟆・螂ｳ",c:"#f9a8d4",g:"蟆丞ｭｦ逕滂ｼ亥･ｳ蟄撰ｼ・},{id:"f_elem5",l:"蟆・螂ｳ蟄・,s:"蟆・螂ｳ",c:"#f9a8d4",g:"蟆丞ｭｦ逕滂ｼ亥･ｳ蟄撰ｼ・},{id:"f_elem6",l:"蟆・螂ｳ蟄・,s:"蟆・螂ｳ",c:"#f9a8d4",g:"蟆丞ｭｦ逕滂ｼ亥･ｳ蟄撰ｼ・},
  {id:"f_jhs1",l:"荳ｭ1螂ｳ蟄・,s:"荳ｭ1螂ｳ",c:"#f9a8d4",g:"荳ｭ蟄ｦ逕滂ｼ亥･ｳ蟄撰ｼ・},{id:"f_jhs2",l:"荳ｭ2螂ｳ蟄・,s:"荳ｭ2螂ｳ",c:"#f9a8d4",g:"荳ｭ蟄ｦ逕滂ｼ亥･ｳ蟄撰ｼ・},{id:"f_jhs3",l:"荳ｭ3螂ｳ蟄・,s:"荳ｭ3螂ｳ",c:"#f9a8d4",g:"荳ｭ蟄ｦ逕滂ｼ亥･ｳ蟄撰ｼ・},
  {id:"f_hs",l:"鬮俶｡螂ｳ蟄・,s:"鬮俶｡螂ｳ",c:"#dc2626",g:"鬮俶｡逕滂ｼ亥･ｳ蟄撰ｼ・},{id:"f_univ",l:"螟ｧ蟄ｦ螂ｳ蟄・,s:"螟ｧ蟄ｦ螂ｳ",c:"#dc2626",g:"螟ｧ蟄ｦ逕滂ｼ亥･ｳ蟄撰ｼ・},
  {id:"f_20s",l:"20莉｣螂ｳ蟄・,s:"20莉｣螂ｳ",c:"#dc2626",g:"繝槭せ繧ｿ繝ｼ繧ｺ・亥･ｳ蟄撰ｼ・},{id:"f_30s",l:"30莉｣螂ｳ蟄・,s:"30莉｣螂ｳ",c:"#dc2626",g:"繝槭せ繧ｿ繝ｼ繧ｺ・亥･ｳ蟄撰ｼ・},{id:"f_40s",l:"40莉｣螂ｳ蟄・,s:"40莉｣螂ｳ",c:"#dc2626",g:"繝槭せ繧ｿ繝ｼ繧ｺ・亥･ｳ蟄撰ｼ・},{id:"f_50s",l:"50莉｣螂ｳ蟄・,s:"50莉｣螂ｳ",c:"#dc2626",g:"繝槭せ繧ｿ繝ｼ繧ｺ・亥･ｳ蟄撰ｼ・},{id:"f_60s",l:"60莉｣螂ｳ蟄・,s:"60莉｣螂ｳ",c:"#dc2626",g:"繝槭せ繧ｿ繝ｼ繧ｺ・亥･ｳ蟄撰ｼ・},{id:"f_70s",l:"70莉｣莉･荳雁･ｳ蟄・,s:"70莉｣莉･荳雁･ｳ",c:"#dc2626",g:"繝槭せ繧ｿ繝ｼ繧ｺ・亥･ｳ蟄撰ｼ・},
];
const CMAP = Object.fromEntries(CATS.map(c=>[c.id,c]));
const CGROUPS = ["蟆丞ｭｦ逕滂ｼ育塙蟄撰ｼ・,"荳ｭ蟄ｦ逕滂ｼ育塙蟄撰ｼ・,"鬮俶｡逕滂ｼ育塙蟄撰ｼ・,"螟ｧ蟄ｦ逕滂ｼ育塙蟄撰ｼ・,"繝槭せ繧ｿ繝ｼ繧ｺ・育塙蟄撰ｼ・,"蟆丞ｭｦ逕滂ｼ亥･ｳ蟄撰ｼ・,"荳ｭ蟄ｦ逕滂ｼ亥･ｳ蟄撰ｼ・,"鬮俶｡逕滂ｼ亥･ｳ蟄撰ｼ・,"螟ｧ蟄ｦ逕滂ｼ亥･ｳ蟄撰ｼ・,"繝槭せ繧ｿ繝ｼ繧ｺ・亥･ｳ蟄撰ｼ・];
const DIST = {"1000m":1000,"1500m":1500,"2000m":2000,"3000m":3000,"5000m":5000,"10000m":10000,"繝上・繝輔・繝ｩ繧ｽ繝ｳ":21097.5,"繝槭Λ繧ｽ繝ｳ":42195};
...
const SEED=[
  {id:1,name:"逕ｰ荳ｭ 蛛･",category:"m_30s",official:true,trials:[mkT("繝槭Λ繧ｽ繝ｳ",3,12,0,"2023-04-15"),mkT("繝槭Λ繧ｽ繝ｳ",2,58,0,"2024-11-03")]},
  {id:2,name:"菴占陸 鄒主調",category:"f_20s",official:true,trials:[mkT("繝上・繝輔・繝ｩ繧ｽ繝ｳ",1,35,0,"2023-09-17"),mkT("繝上・繝輔・繝ｩ繧ｽ繝ｳ",1,28,30,"2024-10-14")]},
  {id:3,name:"驤ｴ譛ｨ 諡謎ｹ・,category:"m_hs",official:true,trials:[mkT("5000m",0,19,30,"2023-05-20"),mkT("5000m",0,17,45,"2024-09-08")]},
  {id:4,name:"螻ｱ逕ｰ 闃ｱ蟄・,category:"f_40s",official:true,trials:[mkT("10000m",0,44,10,"2023-07-01"),mkT("10000m",0,41,20,"2024-08-18")]},
  {id:5,name:"莨願陸 隱",category:"m_50s",official:true,trials:[mkT("繝槭Λ繧ｽ繝ｳ",3,48,0,"2023-03-12"),mkT("繝槭Λ繧ｽ繝ｳ",3,25,0,"2024-10-06")]},
  {id:6,name:"荳ｭ譚・闥ｼ",category:"m_jhs2",official:true,trials:[mkT("3000m",0,10,20,"2024-05-12"),mkT("3000m",0,9,45,"2024-10-08")]},
  {id:7,name:"譚ｾ譛ｬ 闡ｵ",category:"f_univ",official:true,trials:[mkT("5000m",0,16,30,"2023-09-02"),mkT("5000m",0,15,55,"2024-03-17")]},
  {id:8,name:"鬮俶ｩ・豬ｩ荳",category:"m_60s",official:true,trials:[mkT("繝槭Λ繧ｽ繝ｳ",4,10,0,"2023-06-04"),mkT("繝槭Λ繧ｽ繝ｳ",3,58,30,"2024-04-14")]},
];
const enrich = (m) => {
...
function Chart({trials,color}){
  const RANGES=[{l:"1M",days:30},{l:"6M",days:182},{l:"1Y",days:365},{l:"蜈ｨ菴・,days:Infinity}];
  const [range,setRange]=useState(2); // 繝・ヵ繧ｩ繝ｫ繝茨ｼ・Y
  const now=new Date();
  ...
  return (
    <div>
      ...
      {filtered.length<2&&(
        <div style={{textAlign:"center",padding:"20px 0",fontSize:11,color:"#444",fontFamily:"Noto Sans JP,sans-serif"}}>縺薙・譛滄俣縺ｮ險倬鹸縺・莉ｶ莉･荳九・縺溘ａ蜈ｨ菴楢｡ｨ遉ｺ</div>
      )}
        ...
        <svg width={W} height={TOT} viewBox={"0 0 "+W+" "+TOT} style={{display:"block",overflow:"visible"}}>
          ...
          {shown.map((t,i)=>{ const x=cx(i),y=cy(t.vdot); return (
            <g key={t.id}>
              ...
              <text x={x} y={PT+CH+31} textAnchor="middle" fill="#555" fontSize="8" fontFamily="sans-serif">{t.distance.replace("繝上・繝輔・繝ｩ繧ｽ繝ｳ","HM").replace("繝槭Λ繧ｽ繝ｳ","繝輔Ν")}</text>
...
function CatSel({value,onChange}){
  const [gTab,setGTab]=useState(value&&value.startsWith("f_")?"螂ｳ蟄・:"逕ｷ蟄・);
  // 陦悟ｮ夂ｾｩ・喙繝ｩ繝吶Ν, 繧ｰ繝ｫ繝ｼ繝怜錐]
  const rows=[
    {label:"蟆上・荳ｭ蟄ｦ逕・,groups:[`蟆丞ｭｦ逕滂ｼ・{gTab}・荏,`荳ｭ蟄ｦ逕滂ｼ・{gTab}・荏]},
    {label:"鬮俶｡繝ｻ螟ｧ蟄ｦ",groups:[`鬮俶｡逕滂ｼ・{gTab}・荏,`螟ｧ蟄ｦ逕滂ｼ・{gTab}・荏]},
    {label:"繝槭せ繧ｿ繝ｼ繧ｺ",groups:[`繝槭せ繧ｿ繝ｼ繧ｺ・・{gTab}・荏]},
  ];
  return (
    <div>
...
function TI({vals,onChange}){
  const fields=[{key:"h",lbl:"譎る俣",ph:"0",sep:null},{key:"m",lbl:"蛻・,ph:"00",sep:":"},{key:"s",lbl:"遘・,ph:"00",sep:":"},{key:"cs",lbl:"1/100",ph:"00",sep:"."}];
  return (
...
function VP({distance,h,m,s,cs}){
  ...
  return (
    <div style={{background:`${color}0d`,border:`1px solid ${color}25`,borderRadius:6,padding:"10px 14px",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
      <div><div style={{fontSize:9,color:"#555",marginBottom:2,fontFamily:"Noto Sans JP,sans-serif"}}>謗ｨ螳啖DOT</div><div style={{fontSize:11,color:"#777",fontFamily:"Noto Sans JP,sans-serif"}}>{vrl(vv)}</div></div>
  ...
  return (
    <FF label="險倬鹸縺ｮ蛹ｺ蛻・>
      <div style={{display:"flex",gap:8}}>
        {[{v:true,l:"蜈ｬ蠑・,desc:"繝ｩ繝ｳ繧ｭ繝ｳ繧ｰ縺ｫ蜿肴丐"},{v:false,l:"髱槫・蠑・,desc:"TT縺ｮ縺ｿ謗ｲ霈・}].map(opt=>(
    ...
    <div className="ov" onClick={e=>e.target===e.currentTarget&&onClose()}>
      <div className="mo" style={{maxWidth:320,textAlign:"center",paddingBottom:32}}>
        <div style={{marginBottom:24}}>
          ...
          <div style={{fontFamily:"Barlow Condensed,sans-serif",fontWeight:900,fontSize:22,color:"#fff",fontStyle:"italic"}}>邂｡逅・・IN</div>
        ...
        {err&&<div style={{fontSize:11,color:"#ef4444",fontFamily:"Noto Sans JP,sans-serif",marginBottom:16,marginTop:-16}}>PIN縺碁＆縺・∪縺・/div>}
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:10,maxWidth:240,margin:"0 auto"}}>
          {["1","2","3","4","5","6","7","8","9","","0","竚ｫ"].map((k,i)=>(
            <button key={i} onClick={()=>k==="竚ｫ"?del():k!==""?hit(k):null}
              style={{height:56,borderRadius:8,border:"1px solid #2e2e2e",background:k===""?"transparent":"#1a1a1a",color:k==="竚ｫ"?"#888":"#f0f0f0",fontSize:k==="竚ｫ"?20:22,fontFamily:"Barlow Condensed,sans-serif",fontWeight:700,cursor:k===""?"default":"pointer",opacity:k===""?0:1}}>
              {k}
            </button>
          ))}
        </div>
        <button onClick={onClose} style={{marginTop:18,background:"#1a1a1a",border:"1px solid #333",borderRadius:8,color:"#999",fontFamily:"Noto Sans JP,sans-serif",fontSize:14,fontWeight:600,cursor:"pointer",padding:"12px 0",width:"100%"}}>繧ｭ繝｣繝ｳ繧ｻ繝ｫ</button>
      </div>
    </div>
  );
}

function Empty({label}){return (<div style={{textAlign:"center",padding:"52px 20px",color:"#333"}}><div style={{fontFamily:"Barlow Condensed,sans-serif",fontWeight:900,fontSize:44,color:"#1a1a1a",marginBottom:10}}>窶・/div><div style={{fontSize:12,fontFamily:"Noto Sans JP,sans-serif"}}>{label}</div></div>);}
function Toast(){const [v,setV]=useState(1);useEffect(()=>{const t=setTimeout(()=>setV(0),1600);return()=>clearTimeout(t);},[]);return (<div style={{position:"fixed",bottom:24,left:"50%",transform:"translateX(-50%)",background:"#1e1e1e",border:"1px solid #2e2e2e",borderRadius:20,padding:"8px 18px",fontFamily:"Noto Sans JP,sans-serif",fontSize:13,fontWeight:600,color:"#aaa",zIndex:999,whiteSpace:"nowrap",opacity:v,transition:"opacity .4s"}}>笨・菫晏ｭ倥＠縺ｾ縺励◆</div>);}
...
function TTPage({ttData,onOpenMember}){
  ...
  if(ttData.length===0)return (<div style={{textAlign:"center",padding:"52px 20px",color:"#333"}}><div style={{fontSize:40,marginBottom:12}}>潤</div><div style={{fontSize:13,fontFamily:"Noto Sans JP,sans-serif",lineHeight:1.8}}>TT險倬鹸縺後≠繧翫∪縺帙ｓ<br/>險倬鹸霑ｽ蜉譎ゅ↓縲檎ｬｬ笳句屓TT縲咲分蜿ｷ繧貞・蜉帙＠縺ｦ縺上□縺輔＞</div></div>);
  return (
    <div className="pi">
        ...
        <div>
          <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:16,paddingBottom:12,borderBottom:"1px solid #252525"}}>
            ...
            <div>
              ...
              <div style={{fontSize:10,color:"#555",fontFamily:"Noto Sans JP,sans-serif"}}>{selTTData.trials.length}莉ｶ縺ｮ險倬鹸</div>
            </div>
          </div>
          <div style={{display:"flex",gap:8,flexWrap:"wrap",marginBottom:16}}>
            {availDists.map(d=>(<button key={d} className={`dist-pill ${selDist===d?"sel":""}`} onClick={()=>setSelDist(d)}>{d}</button>))}
          </div>
          {ranking.length===0&&<Empty label="縺薙・遞ｮ逶ｮ縺ｮ險倬鹸縺後≠繧翫∪縺帙ｓ"/>}
...
function App(){
  ...
  // 驕ｸ謇九・蜷・ｨ倬鹸縺後き繝・ざ繝ｪ繝ｼ蜀・〒菴穂ｽ阪°繧定ｨ育ｮ・  const catRankMap=useMemo(()=>{
    if(!am) return {};
    const map={};
    // 繧ｫ繝・ざ繝ｪ繝ｼﾃ礼ｨｮ逶ｮ縺斐→縺ｫ驕ｸ謇九・繝吶せ繝郁ｨ倬鹸縺ｮID繧堤音螳壹＠縲√◎繧後・縺ｿ繧貞愛螳・    const bestByKey={};
    am.trials.forEach(t=>{
  ...
  const ttData=useMemo(()=>{
    ...
    members.forEach(m=>{
      m.trials.filter(t=>t.event_no).forEach(t=>{
        const no=t.event_no;
        if(!map[no])map[no]={event_no:no,event_name:t.event_name||`隨ｬ${no}蝗杁T`,trials:[],date:t.date};
  ...
  async function addMember(){
    ...
    const enm=eno?`隨ｬ${eno}蝗杁T`:mForm.event_name_input.trim()||null;
  ...
  async function addTrial(){
    ...
    const enm=eno?`隨ｬ${eno}蝗杁T`:tForm.event_name_input.trim()||null;
  ...
  async function saveTrial(){
    ...
    const enm=eno?`隨ｬ${eno}蝗杁T`:eForm.event_name_input.trim()||null;
  ...
  if(loading)return(
    <div style={{minHeight:"100dvh",display:"flex",alignItems:"center",justifyContent:"center",background:"#0d0d0d"}}>
      <div style={{textAlign:"center"}}>
        ...
        <div style={{fontSize:11,color:"#444",fontFamily:"Noto Sans JP,sans-serif"}}>隱ｭ縺ｿ霎ｼ縺ｿ荳ｭ...</div>
      </div>
    </div>
  );
  return (
    <div style={{minHeight:"100vh",background:"#0d0d0d",color:"#f0f0f0"}}>
          ...
          <header className="sh">
            ...
            <div style={{maxWidth:760,margin:"0 auto",padding:"0 16px"}}>
              <div className="tab-bar">
                ...
                <button className={`ti ${mainTab==="tt"?"on":""}`} onClick={()=>setMainTab("tt")}>TT蛻･</button>
              ...
              <div className="pi">
                ...
                <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:16,paddingBottom:12,borderBottom:"1px solid #252525"}}>
                  ...
                  <div>
                    ...
                    <div style={{fontSize:10,color:"#555",fontFamily:"Noto Sans JP,sans-serif"}}>{distRanking.length}蜷阪′險倬鹸縺ゅｊ ﾂｷ 繧ｿ繧､繝鬆・/div>
                  </div>
                </div>
      ...
      {showAddM&&<Modal onClose={()=>setShowAddM(false)} title="繝｡繝ｳ繝舌・繧定ｿｽ蜉">
        ...
        <FF label="繝｡繝ｳ繝舌・蛹ｺ蛻・>
          <div style={{display:"flex",gap:8}}>
            {[{v:true,l:"蜈ｬ蠑上Γ繝ｳ繝舌・",desc:"繝ｩ繝ｳ繧ｭ繝ｳ繧ｰ縺ｫ謗ｲ霈・},{v:false,l:"髱槫・蠑上Γ繝ｳ繝舌・",desc:"TT縺ｮ縺ｿ謗ｲ霈・}].map(opt=>(
        ...
        <FF label="繧ｫ繝・ざ繝ｪ繝ｼ"><CatSel value={mForm.category} onChange={v=>setMF(f=>({...f,category:v}))}/></FF>
        <FF label="遞ｮ逶ｮ"><select className="inp" value={mForm.distance} onChange={e=>setMF(f=>({...f,distance:e.target.value}))}>{DK.map(d=>(<option key={d}>{d}</option>))}</select></FF>
        <FF label="繧ｿ繧､繝"><TI vals={mForm} onChange={(k,v)=>setMF(f=>({...f,[k]:v}))}/></FF>
        <FF label="繧､繝吶Φ繝医・螟ｧ莨壼錐・井ｻｻ諢擾ｼ・>
          <input className="inp" placeholder="萓具ｼ壽丼蟄｣險倬鹸莨壹∵擲莠ｬ繝槭Λ繧ｽ繝ｳ" value={mForm.event_name_input||""} onChange={e=>setMF(f=>({...f,event_name_input:e.target.value,event_no:""}))}/>
        </FF>
        <FF label="繧ｿ繧､繝繝医Λ繧､繧｢繝ｫ縺ｮ蝣ｴ蜷医・蝗樊焚繧貞・蜉・>
          <div style={{display:"flex",alignItems:"center",gap:8}}>
            <span style={{fontFamily:"Noto Sans JP,sans-serif",fontSize:13,color:"#aaa",whiteSpace:"nowrap"}}>隨ｬ</span>
            ...
            <span style={{fontFamily:"Noto Sans JP,sans-serif",fontSize:13,color:"#aaa",whiteSpace:"nowrap"}}>蝗杁T</span>
            {mForm.event_no&&<span style={{fontSize:11,color:"#ff4d00",fontFamily:"Noto Sans JP,sans-serif",fontWeight:700}}>隨ｬ{mForm.event_no}蝗杁T</span>}
          </div>
        </FF>
        ...
        <div style={{display:"flex",gap:8}}><button className="bg" style={{flex:1}} onClick={()=>setShowAddM(false)}>繧ｭ繝｣繝ｳ繧ｻ繝ｫ</button><button className="ba" style={{flex:2}} onClick={addMember}>霑ｽ蜉縺吶ｋ</button></div>
      </Modal>}

      {showAddT&&<Modal onClose={()=>setShowAddT(false)} title="繧ｿ繧､繝繧定ｨ倬鹸">
        <FF label="繧､繝吶Φ繝医・螟ｧ莨壼錐・井ｻｻ諢擾ｼ・>
          <input className="inp" placeholder="萓具ｼ壽丼蟄｣險倬鹸莨壹∵擲莠ｬ繝槭Λ繧ｽ繝ｳ" value={tForm.event_name_input||""} onChange={e=>setTF(f=>({...f,event_name_input:e.target.value,event_no:""}))}/>
        </FF>
        <FF label="繧ｿ繧､繝繝医Λ繧､繧｢繝ｫ縺ｮ蝣ｴ蜷医・蝗樊焚繧貞・蜉・>
          <div style={{display:"flex",alignItems:"center",gap:8}}>
            <span style={{fontFamily:"Noto Sans JP,sans-serif",fontSize:13,color:"#aaa",whiteSpace:"nowrap"}}>隨ｬ</span>
            ...
            <span style={{fontFamily:"Noto Sans JP,sans-serif",fontSize:13,color:"#aaa",whiteSpace:"nowrap"}}>蝗杁T</span>
            {tForm.event_no&&<span style={{fontSize:11,color:"#ff4d00",fontFamily:"Noto Sans JP,sans-serif",fontWeight:700}}>隨ｬ{tForm.event_no}蝗杁T</span>}
          </div>
        </FF>
        <FF label="繧ｫ繝・ざ繝ｪ繝ｼ・亥､画峩蜿ｯ・・><CatSel value={tForm.category||am?.category||"m_elem4"} onChange={v=>setTF(f=>({...f,category:v}))}/></FF>
        <FF label="遞ｮ逶ｮ"><select className="inp" value={tForm.distance} onChange={e=>setTF(f=>({...f,distance:e.target.value}))}>{DK.map(d=>(<option key={d}>{d}</option>))}</select></FF>
        ...
        <div style={{display:"flex",gap:8}}><button className="bg" style={{flex:1}} onClick={()=>setShowAddT(false)}>繧ｭ繝｣繝ｳ繧ｻ繝ｫ</button><button className="ba" style={{flex:2}} onClick={addTrial}>險倬鹸縺吶ｋ</button></div>
      </Modal>}

      {showReset&&<Modal onClose={()=>setShowReset(false)} title="繝・・繧ｿ繧偵Μ繧ｻ繝・ヨ">
        <div style={{fontSize:13,color:"#777",lineHeight:1.7,marginBottom:16,fontFamily:"Noto Sans JP,sans-serif"}}>蜈ｨ繝・・繧ｿ縺悟炎髯､縺輔ｌ繧ｵ繝ｳ繝励Ν繝・・繧ｿ縺ｫ謌ｻ繧翫∪縺吶・/div>
...
function MemberPage({member,onBack,onAddTrial,onDelTrial,onDelMember,requirePin,catRankMap,onEditTrial,editTrial,eForm,setEF,onSaveTrial,onCancelEdit}){
  ...
  const paceItems=[{l:"繧､繝ｼ繧ｸ繝ｼ襍ｰ",v:paces.easy,c:"#22c55e"},{l:"繝槭Λ繧ｽ繝ｳ繝壹・繧ｹ",v:paces.marathon,c:"#3b82f6"},{l:"髢ｾ蛟､繝壹・繧ｹ",v:paces.threshold,c:"#f97316"},{l:"繧､繝ｳ繧ｿ繝ｼ繝舌Ν",v:paces.interval,c:"#ec4899"},{l:"繝ｬ繝壹ユ繧｣繧ｷ繝ｧ繝ｳ",v:paces.rep,c:"#a855f7"}];
      ...
      <header className="sh">
        <div style={{maxWidth:760,margin:"0 auto",padding:"0 16px"}}>
          <div style={{display:"flex",alignItems:"center",gap:12,height:58}}>
            <button onClick={onBack} style={{background:"none",border:"none",color:"#666",cursor:"pointer",fontSize:26,lineHeight:1,padding:"0 4px"}} onMouseEnter={e=>e.currentTarget.style.color="#fff"} onMouseLeave={e=>e.currentTarget.style.color="#666"}>窶ｹ</button>
            <div style={{flex:1,minWidth:0}}>
              <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:2}}>
                <span style={{fontWeight:700,fontSize:20,fontFamily:"Noto Sans JP,sans-serif",letterSpacing:"-.01em"}}>{member.name}</span>
                {member.official===false&&<span style={{fontSize:9,fontFamily:"Noto Sans JP,sans-serif",color:"#6366f1",border:"1px solid #6366f128",background:"rgba(99,102,241,.08)",padding:"2px 5px",borderRadius:3}}>髱槫・蠑・/span>}
                {cat&&<span className="cp" style={{background:`${cat.c}15`,color:cat.c,border:`1px solid ${cat.c}28`}}>{cat.s}</span>}
              </div>
              <div style={{fontSize:10,color:"#555",fontFamily:"Noto Sans JP,sans-serif"}}>{member.official===false?"髱槫・蠑上Γ繝ｳ繝舌・":member.rank?`#${member.rank}菴・ﾂｷ ${rank}`:rank}</div>
            </div>
            <div style={{textAlign:"right",flexShrink:0}}>
          ...
          <div className="pi">
            ...
            <div style={{display:"flex",gap:9,marginBottom:14}}>
              <div className="card" style={{flex:1,padding:"12px 14px"}}>
                <div style={{fontSize:9,color:"#555",marginBottom:5,fontFamily:"Noto Sans JP,sans-serif"}}>險倬鹸蝗樊焚</div>
                <div style={{fontFamily:"Barlow Condensed,sans-serif",fontWeight:900,fontSize:22,color:"#ddd",marginTop:3,fontStyle:"italic"}}>{member.trials.length}蝗・/div>
              </div>
            </div>
            {chrono.length>=2&&(
              ...
              <div key={t.id} className={`tr fu ${isPB?"pb":""}`} style={{animationDelay:`${i*28}ms`,cursor:"pointer"}} onContextMenu={e=>{e.preventDefault();onEditTrial(t);}} onTouchStart={e=>{const timer=setTimeout(()=>onEditTrial(t),600);e.currentTarget._lp=timer;}} onTouchEnd={e=>{clearTimeout(e.currentTarget._lp);}} onTouchMove={e=>{clearTimeout(e.currentTarget._lp);}}>
                <div style={{flexShrink:0,minWidth:72}}>
                  ...
                  <div style={{display:"flex",alignItems:"center",gap:4,marginTop:2,flexWrap:"wrap"}}>
                    ...
                    {!t.event_name&&t.id===display[0].id&&<span style={{fontSize:9,color:"#ff4d00",fontFamily:"Noto Sans JP,sans-serif"}}>譛譁ｰ</span>}
            ...
            {editTrial&&(
              <div className="ov" onClick={e=>e.target===e.currentTarget&&onCancelEdit()}>
                <div className="mo">
                  <div style={{marginBottom:20}}><div style={{width:26,height:3,background:"#6366f1",borderRadius:2,marginBottom:8}}/><div style={{fontFamily:"Barlow Condensed,sans-serif",fontWeight:900,fontSize:21,color:"#fff",fontStyle:"italic"}}>險倬鹸繧堤ｷｨ髮・/div></div>
                  <div style={{display:"flex",flexDirection:"column",gap:14}}>
                    <FF label="繧､繝吶Φ繝医・螟ｧ莨壼錐・井ｻｻ諢擾ｼ・>
                      <input className="inp" placeholder="萓具ｼ壽丼蟄｣險倬鹸莨壹∵擲莠ｬ繝槭Λ繧ｽ繝ｳ" value={eForm.event_name_input||""} onChange={e=>setEF(f=>({...f,event_name_input:e.target.value,event_no:""}))}/>
                    </FF>
                    <FF label="繧ｿ繧､繝繝医Λ繧､繧｢繝ｫ縺ｮ蝣ｴ蜷医・蝗樊焚">
                      <div style={{display:"flex",alignItems:"center",gap:8}}>
                        <span style={{fontFamily:"Noto Sans JP,sans-serif",fontSize:13,color:"#aaa",whiteSpace:"nowrap"}}>隨ｬ</span>
                        ...
                        <span style={{fontFamily:"Noto Sans JP,sans-serif",fontSize:13,color:"#aaa",whiteSpace:"nowrap"}}>蝗杁T</span>
                        {eForm.event_no&&<span style={{fontSize:11,color:"#6366f1",fontFamily:"Noto Sans JP,sans-serif",fontWeight:700}}>隨ｬ{eForm.event_no}蝗杁T</span>}
                      </div>
                    </FF>
                    <FF label="繧ｫ繝・ざ繝ｪ繝ｼ"><CatSel value={eForm.category||member.category} onChange={v=>setEF(f=>({...f,category:v}))}/></FF>
                    <FF label="遞ｮ逶ｮ"><select className="inp" value={eForm.distance} onChange={e=>setEF(f=>({...f,distance:e.target.value}))}>{DK.map(d=>(<option key={d}>{d}</option>))}</select></FF>
                    <FF label="繧ｿ繧､繝"><TI vals={eForm} onChange={(k,v)=>setEF(f=>({...f,[k]:v}))}/></FF>
                    <FF label="譌･莉・><input className="inp" type="date" value={eForm.date} onChange={e=>setEF(f=>({...f,date:e.target.value}))}/></FF>
                    ...
                    <div style={{display:"flex",gap:8}}>
                      <button className="bg" style={{flex:1}} onClick={onCancelEdit}>繧ｭ繝｣繝ｳ繧ｻ繝ｫ</button>
                      <button style={{flex:2,background:"#6366f1",color:"#fff",border:"none",borderRadius:4,fontSize:13,fontFamily:"Noto Sans JP,sans-serif",fontWeight:700,cursor:"pointer",padding:"9px"}} onClick={onSaveTrial}>菫晏ｭ倥☆繧・/button>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div style={{display:"flex",alignItems:"center",gap:12}}>
        ...
        <div style={{flex:1,minWidth:0}}>
          <div style={{display:"flex",alignItems:"center",gap:7,marginBottom:4}}>
            ...
            {m.official===false&&<span style={{fontSize:9,fontFamily:"Noto Sans JP,sans-serif",color:"#6366f1",border:"1px solid #6366f128",background:"rgba(99,102,241,.08)",padding:"2px 5px",borderRadius:3}}>髱槫・蠑・/span>}
            {cat&&<span className="cp" style={{background:`${cat.c}15`,color:cat.c,border:`1px solid ${cat.c}28`}}>{cat.s}</span>}
          </div>
          {m.bestTrial&&(
