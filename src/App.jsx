  ...
  if(loading)return(
    <div style={{minHeight:"100dvh",display:"flex",alignItems:"center",justifyContent:"center",background:"#0d0d0d"}}>
      <div style={{textAlign:"center"}}>
        <div style={{fontFamily:"Barlow Condensed,sans-serif",fontWeight:900,fontSize:32,color:"#ff4d00",fontStyle:"italic",lineHeight:1.1}}>VAMOS RC</div><div style={{fontFamily:"Noto Sans JP,sans-serif",fontWeight:700,fontSize:14,color:"#ff4d00",marginBottom:8,letterSpacing:"0.05em"}}>記録集計</div>
